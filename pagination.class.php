...
class Pagination
{
    ...
    var $firstLink      = '<div class="first-last">Primeiro</div>';

    var $nextLink       = '&gt;';
    var $prevLink       = '&lt;';

    var $lastLink       = '<div class="first-last">Ultimo</div>';

    var $fullTagOpen    = '<div class="review-pagination">';
    ...
    var $curTagOpen     = '<b class="current">';
    var $curTagClose    = '</b>';
    ...
    var $anchorClass    = 'pagination-link';
    ...
    function createLinks()
    {
        ...
        /*      if ($this->showCount){ 
           ...
           $info = 'Mostrando de ' . ( $currentOffset + 1 ) . ' a ' ; 
